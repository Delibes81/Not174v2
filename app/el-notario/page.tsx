...
export default function ElNotario() {
  ...
  return (
    <div className="min-h-screen bg-background pt-24" ref={containerRef}>
      {/* Header Profile with Parallax */}
      <section className="relative h-[65vh] md:h-[75vh] overflow-hidden bg-primary">
        ...
        >
          <img 
            ...
            alt="Vctor Rafael Aguilar Molina" 
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              <div className="flex flex-wrap gap-3 mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-tertiary/20 border border-tertiary/40 rounded-full backdrop-blur-sm">
                  <ShieldCheck className="w-4 h-4 text-tertiary" />
                  <span className="text-tertiary text-xs font-semibold uppercase tracking-widest">Titular de la Notaría 174</span>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-background/80 text-sm md:text-base font-light tracking-wide border-l-2 border-tertiary pl-4">
      ...
      <section className="py-24 relative overflow-hidden">
        {/* Decorative Blob */}
        <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-tertiary/5 rounded-full blur-[100px] pointer-events-none transform translate-x-1/3 -translate-y-1/3"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-16">
              ...
              >
                ...
                <div className="prose prose-lg text-primary/70 leading-relaxed">
                  <p>
                    Desde su nombramiento en 1992 como Titular de la Notaría #174 del Distrito Federal, el Mtro. Víctor Rafael Aguilar Molina ha construido una destacada trayectoria cimentada en la ética y el rigor técnico.
                  </p>
                  <p>
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-3xl shadow-lg border border-tertiary/10"
              >
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-background/50 transition-colors">
                    ...
                    <div>
                      <p className="font-semibold text-primary">Colegio de Notarios de la Ciudad de México, A.C.</p>
                      <p className="text-sm text-primary/50">Miembro desde 1992</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-background/50 transition-colors">
                    <div className="mt-1 w-2 h-2 rounded-full bg-tertiary flex-shrink-0"></div>
                    <div>
                      <p className="font-semibold text-primary">Colegio Nacional del Notariado Mexicano, A.C.</p>
                      <p className="text-sm text-primary/50">Miembro desde 1993</p>
                    </div>
                  </li>
                </ul>
              </motion.div>
              ...
              <motion.div 
                ...
                className="bg-secondary text-white p-8 rounded-3xl shadow-xl relative overflow-hidden"
              >
                ...
                <div className="space-y-8 relative z-10">
                  <div className="relative pl-6 border-l border-tertiary/30">
                    <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 rounded-full bg-tertiary"></div>
                    <p className="text-tertiary text-sm font-semibold mb-1">1978</p>
                    <p className="font-bold text-lg mb-1">Licenciatura en Derecho</p>
                    <p className="text-background/70 text-sm mb-2">Escuela Libre de Derecho</p>
                    <p className="text-xs text-background/40">Cédula Profesional: 557991</p>
                  </div>
                  
                  <div className="relative pl-6 border-l border-tertiary/30">
                    <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 rounded-full bg-tertiary"></div>
                    <p className="text-tertiary text-sm font-semibold mb-1">1990</p>
                    <p className="font-bold text-lg mb-1">Maestría en Derecho Económico</p>
                    <p className="text-background/70 text-sm mb-2">Universidad Autónoma Metropolitana (UAM)</p>
                    <p className="text-xs text-background/40">Cédula Profesional: 1525463</p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="lg:col-span-7">
              <motion.div 
                ...
                className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-primary/5"
              >
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    <h3 className="font-serif text-3xl text-primary font-bold">Cargos Directivos</h3>
                    <p className="text-primary/50 text-sm mt-1">Participación institucional a nivel local y nacional</p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {cargos.map((cargo, index) => (
                    <motion.div 
                      ...
                      className="group flex flex-col md:flex-row gap-4 md:gap-8 items-start p-6 rounded-2xl border border-transparent hover:border-tertiary/20 hover:bg-tertiary/5 transition-all duration-300"
                    >
                      <div className="md:w-1/4 flex-shrink-0">
                        <span className="inline-block px-3 py-1 bg-primary text-white text-sm font-semibold rounded-full group-hover:bg-tertiary group-hover:text-primary transition-colors">
                          {cargo.year}
                        </span>
                      </div>
                      <div className="md:w-3/4">
                        <h4 className="font-bold text-lg text-primary mb-1 group-hover:text-tertiary transition-colors">{cargo.title}</h4>
                        <p className="text-primary/70 text-sm">{cargo.entity}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
