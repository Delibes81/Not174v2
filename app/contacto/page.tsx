      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
        ...
        <div className="flex flex-col space-y-12 lg:space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
            ...
            >
              <div className="bg-white p-8 rounded-3xl shadow-lg border border-notaria-dark/5 h-full">
            ...
            >
              <div className="bg-notaria-dark rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden h-full">
          ...
          <motion.div 
            ...
            className="w-full h-80 md:h-[450px] bg-gray-200 rounded-3xl overflow-hidden shadow-lg border border-notaria-dark/5 relative"
          >
            <iframe
